...
public class IssueVoiceRecord extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_issue_voice_record);
        ...
        record_ok = (Button) findViewById(com.apps.ims.R.id.record_ok);
    }
    ...
    public void onSubmit(View view) {
        ...
        // 確定
        if (view.getId() == com.apps.ims.R.id.record_ok) {
    ...
    private void processViews() {
        record_button = (ImageButton) findViewById(com.apps.ims.R.id.record_button);
        record_volumn = (ProgressBar) findViewById(com.apps.ims.R.id.record_volumn);
        // 隱藏狀態列ProgressBar
    ...
    public void clickRecord(View view) {
        ...
        if (isRecording) {
            ...
            // 設定按鈕圖示為錄音中
            record_button.setImageResource(com.apps.ims.R.mipmap.btn_microphone);
            // 建立錄音物件
        ...
        // 停止錄音
            ...
            // 設定按鈕圖示為停止錄音
            record_button.setImageResource(com.apps.ims.R.mipmap.btn_microphone_nor);
            // 麥克風音量歸零
