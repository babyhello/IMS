...
public class project_expandtable extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.apps.ims.R.layout.activity_project_expandtable, container, false);
        ...
        elv = (ExpandableListView) v.findViewById(com.apps.ims.R.id.mExpandableListView);
    ...
    class ExpandableAdapter extends BaseExpandableListAdapter {
        ...
        */
        ...
        public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView,
            ...
            v = mLayInf.inflate(com.apps.ims.R.layout.project_item, parent, false);

            final ImageView Img_ProjectImage = (ImageView) v.findViewById(com.apps.ims.R.id.Img_ProjectImage);
            ...
            TextView txt_Project_Name = (TextView) v.findViewById(com.apps.ims.R.id.txt_Project_Name);
            ...
            TextView txt_Issue_WorkNoteCount = (TextView) v.findViewById(com.apps.ims.R.id.txt_Issue_WorkNoteCount);
            ...
            Glide.with(context)
                    ...
                    .asBitmap()
                    .placeholder(com.apps.ims.R.mipmap.logo_dragon)
                    .error(com.apps.ims.R.mipmap.logo_dragon)
...
//獲取一級清單佈局檔,設置相應元素屬性
            LinearLayout linearLayout = (LinearLayout) layoutInflater.inflate(com.apps.ims.R.layout.group, null);
            TextView textView = (TextView) linearLayout.findViewById(com.apps.ims.R.id.group_tv);
