...
public class IssueAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = mLayInf.inflate(com.apps.ims.R.layout.issue_item, parent, false);

        ImageView Img_Priority = (ImageView) v.findViewById(com.apps.ims.R.id.Img_Priority);

        TextView txt_Issue_Project_Name = (TextView) v.findViewById(com.apps.ims.R.id.txt_Issue_Project_Name);

        TextView txt_Issue_Date = (TextView) v.findViewById(com.apps.ims.R.id.txt_Issue_Date);

        TextView txt_Issue_Subject = (TextView) v.findViewById(com.apps.ims.R.id.txt_Issue_Subject);

        TextView txt_Issue_WorkNoteCount = (TextView) v.findViewById(com.apps.ims.R.id.txt_Issue_WorkNoteCount);

        TextView IssueList_Author = (TextView) v.findViewById(com.apps.ims.R.id.IssueList_Author);
