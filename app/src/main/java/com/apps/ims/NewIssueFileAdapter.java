...
public class NewIssueFileAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = mLayInf.inflate(com.apps.ims.R.layout.newissuefile_item, parent, false);

        ImageView Img_Issue_File = (ImageView) v.findViewById(com.apps.ims.R.id.Img_Issue_File);
        ...
        switch (NewIssueFile_List.get(position).GetFileType()) {
            ...
            case Voice:
                ...
                v = mLayInf.inflate(com.apps.ims.R.layout.newissuefile_voice, parent, false);
            ...
            case Video:
                ...
                v = mLayInf.inflate(com.apps.ims.R.layout.newissuefilevideo_item, parent, false);
...
//                });
                ...
                IssueVideoPlay mIssueVideoPlay = (IssueVideoPlay) v.findViewById(com.apps.ims.R.id.IssueVideoPlay);
