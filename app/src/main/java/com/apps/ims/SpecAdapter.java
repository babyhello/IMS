...
public class SpecAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = mLayInf.inflate(com.apps.ims.R.layout.spec_item, parent, false);


        TextView txt_Spec_ComponentName = (TextView) v.findViewById(com.apps.ims.R.id.txt_Spec_ComponentName);
        TextView txt_Spec_ComponentContent = (TextView) v.findViewById(com.apps.ims.R.id.txt_Spec_ComponentContent);
