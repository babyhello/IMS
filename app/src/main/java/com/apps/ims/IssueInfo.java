...
public class IssueInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_issue_info);
        ...
        //宣告 ListView 元件
        lsv_main = (ListView) findViewById(com.apps.ims.R.id.listView);
...
//        Issue_File_List(IssueID);
        ...
        mRecyclerView = (RecyclerView) findViewById(com.apps.ims.R.id.Rcy_IssueFile);
        ...
        ImageView Img_IssueAuthor = (ImageView) findViewById(com.apps.ims.R.id.Img_IssueAuthor);

        ImageView Img_IssueInfo_Send = (ImageView) findViewById(com.apps.ims.R.id.Img_IssueInfo_Send);

        Img_IssueInfo_Send.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                EditText txt_Comment = (EditText) findViewById(com.apps.ims.R.id.txt_Comment);
        ...
        ImageView Img_IssueInfo_AddPhoto = (ImageView) findViewById(com.apps.ims.R.id.Img_IssueInfo_AddPhoto);
        ...
        TextView txt_IssueInfo_No = (TextView) findViewById(com.apps.ims.R.id.txt_IssueInfo_No);

        txt_IssueInfo_No.setText("#" + IssueID);


        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(com.apps.ims.R.id.refresh_layout);
...
//        pDialog.show();
    ...
    private void C_Comment_Insert(String Comment) {
        ...
        if (!TextUtils.isEmpty(Comment)) {
            ...
            final ImageView Img_IssueInfo_Send = (ImageView) findViewById(com.apps.ims.R.id.Img_IssueInfo_Send);
    ...
    private void IssueInfoFile_ListMapping(JSONObject result) {
        try {
            ...
            if (IssueInfoFileArray.length() > 0) {
                ...
                LinearLayout RecycleView = (LinearLayout) findViewById(com.apps.ims.R.id.Lie_IssueFile);
    ...
    private void IssueInfoMapping(JSONObject result) {
        try {
            ...
            if (UserArray.length() > 0) {
                ...
                TextView txt_IssueInfo_Author = (TextView) findViewById(com.apps.ims.R.id.txt_IssueInfo_Author);

                TextView txt_IssueInfo_Owner = (TextView) findViewById(com.apps.ims.R.id.txt_IssueInfo_Owner);

                //TextView txt_IssueInfo_ProjectName = (TextView) findViewById(R.id.txt_IssueInfo_ProjectName);

                ImageView Img_IssuePriority = (ImageView) findViewById(com.apps.ims.R.id.Img_IssuePriority);

                TextView txt_IssueInfo_Date = (TextView) findViewById(com.apps.ims.R.id.txt_IssueInfo_Date);

                TextView txt_Issue_Subject = (TextView) findViewById(com.apps.ims.R.id.txt_IssueInfo_Subject);

                ImageView Img_Issue_Status = (ImageView) findViewById(com.apps.ims.R.id.Img_Issue_Status);
                ...
                if (Status_Display.equals("2")) {
                    Img_Issue_Status.setImageResource(com.apps.ims.R.mipmap.ic_verify_arrow);
                } else {
                    Img_Issue_Status.setImageResource(com.apps.ims.R.mipmap.newissue_ic_assign_arrow);
                }
                ...
                final ImageView Img_IssueAuthor = (ImageView) findViewById(com.apps.ims.R.id.Img_IssueAuthor);
...
//        pDialog.show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!Status_Display.equals("3") && Author.equals(UserData.WorkID)) {
            getMenuInflater().inflate(com.apps.ims.R.menu.menu_issue, menu);
        }

        if (Status_Display.equals("1") && !Author.equals(UserData.WorkID)) {
            getMenuInflater().inflate(com.apps.ims.R.menu.menu_issue_owner, menu);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.apps.ims.R.id.CloseIssue) {
            Close_Issue_Fun();
        } else if (id == com.apps.ims.R.id.IssueOwner) {


            Go_Issue_Change_Owner(ModelID, IssueID);
        } else if (id == com.apps.ims.R.id.IssuePriotiry) {
            IssuePriorityChange();
        } else if (id == com.apps.ims.R.id.Verify_Issue) {
            Verify_Issue_Fun();
        } else if (id == com.apps.ims.R.id.Reject_Verify_Issue) {
            Reject_Issue_Fun();
        }
...
//        DataDialog.show();
    ...
    private void Go_Issue_Change_Owner(String ModelID, String IssueID) {
        ...
        // 建構式的第一個參數：「this」
        // 建構式的第二個參數：「Activity元件類別名稱.class」
        Intent intent = new Intent(this, IssueChangeOwner.class);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem RejectMenu = menu.findItem(com.apps.ims.R.id.Reject_Verify_Issue);

        MenuItem CloseMenu = menu.findItem(com.apps.ims.R.id.CloseIssue);
