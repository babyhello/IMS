...
public class Project_Member extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_project_member);
    ...
    private void MemberDataMapping(JSONObject result) {
        try {
            ...
            if (UserArray.length() > 0) {
                ...
                lsv_main.setEmptyView(findViewById(com.apps.ims.R.id.emptyview));

            } else {
                lsv_main.setEmptyView(findViewById(com.apps.ims.R.id.empty));
            }
