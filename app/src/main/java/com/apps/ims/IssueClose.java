...
public class IssueClose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_issue_close);
        ...
        lsv_main.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new AlertDialog.Builder(IssueClose.this)
        ...
        txt_Close_Finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Close_Issue(IssueID, UserData.WorkID, SelectValue);

                C_Comment_Insert("Issue Close  " + txt_Reason.getText().toString(), IssueID);
            }
        });

        LinearLayout Lnl_Picture = (LinearLayout) findViewById(com.apps.ims.R.id.Lnl_Picture);
        LinearLayout Lnl_Camera = (LinearLayout) findViewById(com.apps.ims.R.id.Lnl_Camera);
        LinearLayout Lnl_Microphone = (LinearLayout) findViewById(com.apps.ims.R.id.Lnl_Microphone);
        LinearLayout Lnl_Photo = (LinearLayout) findViewById(com.apps.ims.R.id.Lnl_Photo);
        ...
        ImageButton Btn_Limitation = (ImageButton) findViewById(com.apps.ims.R.id.Btn_Limitation);
        ImageButton Btn_Fixed = (ImageButton) findViewById(com.apps.ims.R.id.Btn_Fixed);
        ImageButton Btn_Waive = (ImageButton) findViewById(com.apps.ims.R.id.Btn_Waive);
        Btn_Limitation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Set_CheckButton("1");
            }
        ...
        Btn_Waive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Set_CheckButton("5");
            }
    ...
    private void Set_CheckButton(String Value) {
        ...
        Btn_Limitation.setBackgroundResource(com.apps.ims.R.mipmap.btn_closeissue_limit_nor);
        Btn_Fixed.setBackgroundResource(com.apps.ims.R.mipmap.btn_closeissue_fixe_nor);
        Btn_Waive.setBackgroundResource(com.apps.ims.R.mipmap.btn_closeissue_waive_nor);


        switch (Value) {
            case "1":

                Btn_Limitation.setBackgroundResource(com.apps.ims.R.mipmap.btn_closeissue_limit_sel);
                break;

            case "2":

                Btn_Fixed.setBackgroundResource(com.apps.ims.R.mipmap.btn_closeissue_fixe_sel);
                break;
            case "5":

                Btn_Waive.setBackgroundResource(com.apps.ims.R.mipmap.btn_closeissue_waive_sel);
                break;
        }
