...
public class IssueClose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton Btn_Limitation = (ImageButton) findViewById(R.id.Btn_Limitation);
        ImageButton Btn_Fixed = (ImageButton) findViewById(R.id.Btn_Fixed);
        ImageButton Btn_Waive = (ImageButton) findViewById(R.id.Btn_Waive);
    ...
    private void Set_CheckButton(String Value) {
        ...
        Btn_Limitation.setBackgroundResource(R.mipmap.btn_closeissue_limit_nor);
        Btn_Fixed.setBackgroundResource(R.mipmap.btn_closeissue_fixe_nor);
        Btn_Waive.setBackgroundResource(R.mipmap.btn_closeissue_waive_nor);


        switch (Value) {
            case "1":

                Btn_Limitation.setBackgroundResource(R.mipmap.btn_closeissue_limit_sel);
                break;

            case "2":

                Btn_Fixed.setBackgroundResource(R.mipmap.btn_closeissue_fixe_sel);
                break;
            case "5":

                Btn_Waive.setBackgroundResource(R.mipmap.btn_closeissue_waive_sel);
                break;
        }
