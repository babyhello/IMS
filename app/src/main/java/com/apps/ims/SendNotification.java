...
public class SendNotification extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_send_notification);

        pDialog = new ProgressDialog(this);

        pDialog.setTitle("Loading...");

        txt_Title = (EditText) findViewById(com.apps.ims.R.id.txt_Title);

        txt_Message = (EditText) findViewById(com.apps.ims.R.id.txt_Message);

        btn_Message_Send = (Button) findViewById(com.apps.ims.R.id.btn_Message_Send);
