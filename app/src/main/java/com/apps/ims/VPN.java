...
public class VPN extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_vpn);
        mServerAddress = (TextView) findViewById(com.apps.ims.R.id.address);
        mServerPort = (TextView) findViewById(com.apps.ims.R.id.port);
        mSharedSecret = (TextView) findViewById(com.apps.ims.R.id.secret);
        findViewById(com.apps.ims.R.id.connect).setOnClickListener(this);
    }
