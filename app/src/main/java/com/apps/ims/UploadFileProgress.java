...
/**
 * Created by androids on 2017/1/5.
 */
public class UploadFileProgress implements UploadStatusDelegate {
    ...
    class UploadProgressViewHolder {
        ...
        @BindView(com.apps.ims.R.id.uploadTitle)
        TextView uploadTitle;
        @BindView(com.apps.ims.R.id.uploadProgress)
        ...
        UploadProgressViewHolder(View view, String filename) {
            ...
            uploadTitle = (TextView) itemView.findViewById(com.apps.ims.R.id.uploadTitle);
            progressBar = (ProgressBar) itemView.findViewById(com.apps.ims.R.id.uploadProgress);
...
//        uploadProgressHolders.remove(uploadInfo.getUploadId());
    ...
    private void addUploadToList(String uploadID, String filename) {
        ...
        View uploadProgressView = inflater.inflate(com.apps.ims.R.layout.view_upload_progress, null);
