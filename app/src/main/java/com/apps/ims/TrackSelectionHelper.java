...
/* package */ final class TrackSelectionHelper implements View.OnClickListener,
    ...
    private View buildView(Context context) {
        ...
        View view = inflater.inflate(com.apps.ims.R.layout.track_selection_dialog, null);
        ViewGroup root = (ViewGroup) view.findViewById(com.apps.ims.R.id.root);
        ...
        disableView.setText(com.apps.ims.R.string.selection_disabled);
        ...
        defaultView.setText(com.apps.ims.R.string.selection_default);
        defaultView.setFocusable(true);
        defaultView.setOnClickListener(this);
        root.addView(inflater.inflate(com.apps.ims.R.layout.list_divider, root, false));
        ...
        if (!haveSupportedTracks) {
            ...
            defaultView.setText(com.apps.ims.R.string.selection_default_none);
        } else if (haveAdaptiveTracks) {
            // View for using random adaptation.
            enableRandomAdaptationView = (CheckedTextView) inflater.inflate(
                    android.R.layout.simple_list_item_multiple_choice, root, false);
            enableRandomAdaptationView.setBackgroundResource(selectableItemBackgroundResourceId);
            enableRandomAdaptationView.setText(com.apps.ims.R.string.enable_random_adaptation);
