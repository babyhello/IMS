...
public class IssueChangePriority extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_issue_change_priority);
        ...
        ImageButton Btn_Priority1 = (ImageButton) findViewById(com.apps.ims.R.id.Btn_Priority1);
        ImageButton Btn_Priority2 = (ImageButton) findViewById(com.apps.ims.R.id.Btn_Priority2);
        ImageButton Btn_Priority3 = (ImageButton) findViewById(com.apps.ims.R.id.Btn_Priority3);
    ...
    private void Set_CheckButton(String Value) {
        ...
        Btn_Priority1.setBackgroundResource(com.apps.ims.R.mipmap.btn_change_priop1_nor);
        Btn_Priority2.setBackgroundResource(com.apps.ims.R.mipmap.btn_change_priop2_nor);
        Btn_Priority3.setBackgroundResource(com.apps.ims.R.mipmap.btn_change_priop3_nor);


        switch (Value) {
            case "1":

                Btn_Priority1.setBackgroundResource(com.apps.ims.R.mipmap.btn_change_priop1_sel);
                break;

            case "2":

                Btn_Priority2.setBackgroundResource(com.apps.ims.R.mipmap.btn_change_priop2_sel);
                break;
            case "3":

                Btn_Priority3.setBackgroundResource(com.apps.ims.R.mipmap.btn_change_priop3_sel);
                break;
        }
