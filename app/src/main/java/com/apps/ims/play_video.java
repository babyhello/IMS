...
public class play_video extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_play_video);
...
// Prepare the player with the source.
            ...
            SimpleExoPlayerView simpleExoPlayerView = (SimpleExoPlayerView) findViewById(com.apps.ims.R.id.player_view);
