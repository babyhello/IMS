...
public class LoginPassword extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.ims.R.layout.activity_login_password);
        Button button = (Button) findViewById(com.apps.ims.R.id.Btn_Login_Password);
        ...
        EditText txt_Login_Account = (EditText) findViewById(com.apps.ims.R.id.txt_Login_Password);
