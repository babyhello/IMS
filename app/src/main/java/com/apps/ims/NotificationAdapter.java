...
public class NotificationAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = mLayInf.inflate(com.apps.ims.R.layout.notification_item, parent, false);

        ImageView Img_Notification_Author = (ImageView) v.findViewById(com.apps.ims.R.id.Img_Notification_Author);


        TextView txt_Notification_Title = (TextView) v.findViewById(com.apps.ims.R.id.txt_Notification_Title);
        TextView txt_Notification_Content = (TextView) v.findViewById(com.apps.ims.R.id.txt_Notification_Content);
        TextView txt_Notification_Date = (TextView) v.findViewById(com.apps.ims.R.id.txt_Notification_Date);
        TextView txt_Notification_AuthorName = (TextView) v.findViewById(com.apps.ims.R.id.txt_Notification_AuthorName);
