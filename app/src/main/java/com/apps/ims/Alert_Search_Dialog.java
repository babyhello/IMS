...
public class Alert_Search_Dialog extends Dialog implements View.OnClickListener {
    ...
    public Alert_Search_Dialog(Context context, String Title, List<List_Item> DataList) {
        ...
        txt_Reason.setBackgroundResource(com.apps.ims.R.drawable.edittextnormalcolor);

        Button Btn_Finish = (Button) findViewById(com.apps.ims.R.id.Btn_Finish);
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(SelectValue)) {
                    if (!TextUtils.isEmpty(txt_Reason.getText().toString())) {
                        ...
                        txt_Reason.setBackgroundResource(com.apps.ims.R.drawable.edittextwarningcolor);
                    }
        ...
        Button Btn_Cancel = (Button) findViewById(com.apps.ims.R.id.Btn_Cancel);
